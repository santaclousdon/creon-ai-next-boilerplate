...
const Home = () => {
  ...
  return (
    <div className="w-full h-auto m-0 p-0 border-0 box-border no-underline align-baseline">
      <div className="flex flex-col w-full relative">
        ...
        <div className="flex justify-between items-center relative px-[240px] pt-[15px] pb-[35px]">
          ...
          <a
            href="#"
            className="flex gap-[6px] font-satoshi leading-[130%] text-[16px] text-white"
          >
            Powered by
            <FooterLetter />
          </a>
    ...
    // <div className="w-full h-auto m-0 p-0 border-0 box-border no-underline align-baseline">
    //   <div className="flex flex-col w-full relative">
    //     <div className="flex absolute left-0 top-0 justify-between w-full px-[1.953vw] py-[2.93vw] items-center z-20">
    //       <a href="/">
    //         <img
    //           className="object-fit"
    //           src="/assets/images/logo.png"
    ...
    //         />
    //       </a>
    //       <div className="flex gap-[1.465vw] font-satoshi">
    //         <div className="flex gap-[2.125vw] items-center">
    //           <a
    //             href="#"
    //             className="font-bold text-white text-lg  leading-custom"
    //           >
    ...
    //           </a>
    //         </div>
    //         <button className="px-[0.977vw] pt-[0.879vw] pb-[1.074vw] text-[1.563vw] text-white font-bold rounded-md border-2 border-white leading-custom">
    //           Connect
    //         </button>
    //       </div>
    //     </div>
    //     <div className="flex flex-col min-h-screen justify-between">
    //       <div className="flex flex-col relative justify-end px-[6.836vw] pt-0 pb-[2.93vw] gap-[1.953vw]">
    //         <div className="absolute left-0 top-0 w-full h-full z-0 object-cover">
    //           <video
    //             className="w-full h-full object-cover z-0"
    //             autoPlay
    ...
    //           alt="background"
    //         />
    //         <h2 className="font-monument font-normal text-[4.297vw] text-white z-10 mt-[48.34vw]  leading-custom">
    //           THE WORLD'S FIRST <br></br>PLATFORM FOR TOKENIZING AI BLOCKCHAIN
    //           PROJECTS
    //         </h2>
    //         <GradientText
